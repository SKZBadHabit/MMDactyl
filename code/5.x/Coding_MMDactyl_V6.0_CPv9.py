...
Codeversion = "Code6.0c"
WlanSSID_Secret = "H_WIFI_SSID"
WlanPW_Secret = "H_WIFI_PASSWORD"
WifiStatus = "Wifi NO"
...
def checkWifiAlive():
    ...
    wifi_status_list = ["Wifi-con", "Wifi/con", "Wifi+con", "Wifi\\con", "Wifi con"]
    wifi_status_list2 = ["Wifi-dis", "Wifi/dis", "Wifi+dis", "Wifi\\dis", "Wifi dis"]
...
ssid = os.getenv(WlanSSID_Secret)
password = os.getenv(WlanPW_Secret)

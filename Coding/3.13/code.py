...
def gaming_mode():
    global gaming_mode_status, DISPLAY_REFRESH_TIME_1, DISPLAY_REFRESH_TIME_2, DISPLAY_REFRESH_TIME_3, DATE_TIME_REFRESH_TIME

    if gaming_mode_status == 0:
        gaming_mode_status = 1

        # Display Refresh time
        DISPLAY_REFRESH_TIME_1 = 999999 # Asynchron for better performance
        DISPLAY_REFRESH_TIME_2 = 999999 # Asynchron for better performance
        DISPLAY_REFRESH_TIME_3 = 999999 # Asynchron for better performance

        cpu_label.text = "     Gaming Mode             "
        runtime_now_label.text = "         SKZ             "
        date_time_label.text = "      BAD HABIT             "

        DATE_TIME_REFRESH_TIME = 60
    
    elif gaming_mode_status == 1:
        gaming_mode_status = 0
        ...
        cpu_label.text = "     Normal Mode             "
        runtime_now_label.text = "                                   "
